...
export default function Home() {
  return (
    <PageShell maxWidth="4xl" showDoodles>
      <PageCard className="relative px-5 py-8 sm:px-10 sm:py-12 md:px-12 md:py-16">
        <div className="relative flex flex-col items-center text-center animate-[rise-in_700ms_ease-out]">
          ...
          <PageTitle className="mt-3 text-4xl sm:mt-5 sm:text-6xl md:text-7xl">
            Doodle Duel
          </PageTitle>
          ...
          <div className="mt-6 flex w-full max-w-md flex-col gap-3 sm:mt-8 sm:flex-row">
            <PrimaryLinkButton
          ...
          <p className="mt-3 text-[11px] uppercase tracking-[0.22em] text-stone-500 sm:mt-4 sm:text-xs sm:tracking-[0.26em]">
